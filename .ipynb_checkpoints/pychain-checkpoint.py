...
sender_data = st.text_input("Enter Sender:", key = "sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver_data = st.text_input("Enter Receiver:", key = "receiver")
                            
# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount_data = st.text_input("Enter Amount:", key = "amount")
